...
const quickStats = [
  ...
  { label: "Experiencia", value: "Profesional", hint: "UI corporativa", icon: "🏢" },
];
      ...
      >
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-4 text-3xl md:text-5xl font-black leading-tight">Bienvenido al panel principal</h1>
